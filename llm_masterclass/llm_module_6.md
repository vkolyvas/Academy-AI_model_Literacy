...
### 1.1 What Made GPT-2 "Modern"? (5+ sentences)
...
### 1.2 Why GPT-2 Still Matters (5+ sentences)
...
### 2.1 Model Size (Parameter Count) (5+ sentences)
...
### 2.2 Context Window (Sequence Length) (5+ sentences)
...
### 2.3 Training Data & Diversity (5+ sentences)
...
### 3.1 Compute Cost (FLOPs & GPU Hours) (5+ sentences)
...
### 3.2 Scaling Laws & Chinchilla Scaling (5+ sentences)
...
### 4.1 The Transformer Block (5+ sentences)
...
### 4.2 Why Alternatives Haven't Replaced Transformers (5+ sentences)
...
### 5.1 Scaling Trajectory (5+ sentences)
...
### 5.2 What Stayed the Same (5+ sentences)
...
Continue to **Module 7 — Base Models vs Assistants** to understand the critical distinction between models trained purely on next-token prediction (base models) and those fine-tuned to be helpful, harmless, and honest (assistant models). This distinction reshapes everything about how we interact with and deploy LLMs.

Run the labs, experiment with different parameter configurations, and build intuition for the cost-performance landscape before proceeding.