...
### 1.1 What Makes a Domain Verifiable (5+ sentences)
...
### 1.2 The Challenge of Unverifiable Domains (5+ sentences)
...
### 2.1 Reward Hacking and Adversarial Collapse (5+ sentences)
...
### 2.2 Why Consensus on Quality is Hard (5+ sentences)
...
### 3.1 Limited RLHF or Hybrid Approaches (5+ sentences)
...
### 3.2 When NOT to Use RLHF (5+ sentences)
...
Continue to **Module 15 — Strategic Summary & Synthesis** for the culmination of the course: connecting all concepts and providing a framework for thinking about LLMs.