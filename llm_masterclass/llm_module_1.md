...
Module 2 dives into **Pre-Training: Internet as Raw Material**. To prepare:

1. **Read**: Consider what "lossy compression of the internet" means—what information is preserved, what's lost?
2. **Experiment**: Try the labs with different models (GPT-4, Llama, Claude) and compare outputs.
3. **Reflect**: Where in your current architecture could a mental model shift improve design decisions?
...
1. **Complete Labs 1-3** in your environment (OCI or local)
2. **Document your findings**: What surprised you? Where did your mental model shift?
3. **Come back to Module 2** when ready to explore pre-training, data scale, and why the model learned what it learned